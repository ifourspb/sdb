...
<div class="handlediv" title="Click to toggle"><br></div><h3 class="hndle"><span>SMS Notifications</span></h3>
<div class="inside">
...
<div class="half-left">
	...
	<div class="mail-field">
  	<label for="wpcf7-sms-recipient">To:</label><br>
...
<div class="half-right">
	<div class="mail-field">
	<label for="wpcf7-mail-body">Message body:</label><br>
